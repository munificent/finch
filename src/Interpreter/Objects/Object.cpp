...
namespace Finch
{
    ...
    Ref<Object> Object::New(Ref<Object> prototype, double value)
    {
    ...
    Ref<Object> Object::New(Ref<Object> prototype, Ref<Expr> value)
    {
        return Ref<Object>(new BlockObject(prototype, value));
    }
    
    Ref<Object> Object::Receive(Ref<Object> thisRef, EvalContext & context,
